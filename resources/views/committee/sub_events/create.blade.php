...
<head>
    ...
    <title>Tambah Sesi untuk Event: {{ $event->name }}</title>
...
<body class="p-8">
    ...
    <div class="container mx-auto bg-white shadow-lg rounded-xl p-8 mb-8">
        <h1 class="text-3xl font-bold text-primary-blue mb-6 border-b-2 border-primary-blue pb-3">Tambah Sesi untuk Event: <span class="text-secondary-blue">{{ $event->name }}</span></h1>
        ...
        <form action="{{ route('committee.events.sub_events.store', $event) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-between mt-8">
                ...
                <a href="{{ route('committee.events.sub_events.index', $event) }}" class="text-gray-600 hover:text-primary-blue transition duration-200">
