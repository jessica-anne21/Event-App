...
<head>
    ...
    <title>Daftar - JesJon University Events</title>
...
<body class="bg-gradient-to-br from-primary-blue to-secondary-blue flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md bg-white shadow-xl rounded-xl p-8 transform hover:scale-105 transition-transform duration-300 ease-in-out">
        <div class="text-center mb-6">
            ...
            <h2 class="text-3xl font-bold text-primary-blue">Daftar</h2>
            <p class="text-gray-600 text-sm">Buat akun baru untuk mengakses Event JesJon University</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            {{-- Name --}}
            <div class="mb-4">
                <label for="name" class="block text-sm font-semibold text-primary-blue mb-2">Nama Lengkap</label>
                <input id="name"
                       type="text"
                       name="name"
                       value="{{ old('name') }}"
        ...
        <p class="text-sm text-center text-gray-600 mt-6">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-primary-blue font-semibold hover:underline transition duration-200">Login Sekarang</a>
        </p>
    </div>
